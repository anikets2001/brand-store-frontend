...
function FlightCard({ badge, img, fromTime, fromCode, toTime, toCode, duration, price, fare }) {
    return (
        <div className="h-[300px] w-full rounded-xl flex  items-center">
            <div className="h-full w-2/4">
                <div className="w-full h-full relative overflow-hidden shrink-0 border-b md:border-b-0 md:border-r-0  md:rounded-xl">
                    <img
                        alt={badge}
            ...
            <div className="h-[80%] w-full flex flex-col md:flex-row items-center justify-between -ml-10 p-4 md:bg-black/70 md:backdrop-blur-sm md:rounded-xl">
