...
const Header = () => {
  ...
  return (
    <nav className="font-airindia-sans absolute w-full top-0 z-50 bg-transparent border-b border-[#f9f6ee]/10 shadow-[0_1px_0_rgba(235,190,105,0.1),0_1px_0_rgba(249,246,238,0.03)]">
